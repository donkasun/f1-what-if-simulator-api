...
class InvalidSimulationParametersError(F1SimulatorError):
    ...
    def __init__(self, details: str):
        ...
        super().__init__(f"Invalid simulation parameters: {details}", "INVALID_SIMULATION_PARAMETERS")
...
class SimulationExecutionError(F1SimulatorError):
    ...
    def __init__(self, simulation_id: str, error: str):
        ...
        self.error = error
        super().__init__(
            f"Simulation {simulation_id} failed: {error}",
...
class CacheError(F1SimulatorError):
    ...
    def __init__(self, operation: str, error: str):
        ...
        self.error = error
        super().__init__(
            f"Cache {operation} failed: {error}",
            "CACHE_ERROR"
        ) 